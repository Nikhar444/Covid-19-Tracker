...
<body>
	...
	//$pat_query="select distinct Latitude,Langitude,FirstcellidaAddress from temp_p where Patient_id='".$pid."'";
	...
	$pat_ll="select distinct p_latitude,p_longitude,FirstcellidaAddress from temp_p where Patient_id='".$pid."'";

...
<script type="text/javascript">
    function get_detail(id)
             ...
             /*  issuedate=document.getElementById("new_issuedate").value;
               if(issuedate!=''){
               //alert(issuedate);
               var reason_id="reason"+id;
               var reason_text=document.getElementById(reason_id).value;
              // alert(reason_text);*/
          /*    $.ajax({
...
$roomid_query="SELECT * FROM `p34n` WHERE FirstcellidaAddress IS NOT NULL and Call_Date='".$da['cdates']."' and Patient_id='".$_POST['patient_id1']."' ORDER BY Call_Date desc,Call_Time"; 
		...
		foreach ($data as $d) {
         ...
         /*   $aangwa_miles=0;
			...
			<tr>
				...
				<td height="25" align="center"><?php  echo date('d-m-Y',strtotime($d['CALLDATE'])); ?></td>
...
$roomid_query="SELECT * FROM `p34n` WHERE FirstcellidaAddress IS NOT NULL and Call_Date='".$da['cdates']."' and Patient_id='".$da['patient_id']."' ORDER BY Patient_id,Call_Date,Call_Time desc"; 
...
<?php } 
	...
	$date_query="select distinct(Call_Date) as cdates from p34n WHERE FirstcellidaAddress IS NOT NULL  and Patient_id='".$_POST['patient_id']."' order by Call_Date desc ";
...
$roomid_query="SELECT * FROM `p34n` WHERE FirstcellidaAddress IS NOT NULL and Call_Date='".$da['cdates']."' and Patient_id='".$_POST['patient_id']."' ORDER BY Call_Date,Call_Time desc"; 
	...
	echo $roomid_query."<br>";
		...
		foreach ($data as $d) {
			...
			<tr>
				<td height="25" align="center"><?php	echo $i++; ?></td>
				<td height="25" align="center"><?php	echo $d['Patient_id']; ?></td>
				<td height="25" align="center"><?php	echo date('d-m-Y',$d['CALLDATE']); ?></td>
				<td height="25" align="center"><?php	echo $d['CALLTYPE']; ?></td>
				<td height="25" align="center"><?php	echo $d['FIRSTCELLIDA']; ?></td>
				<td height="25" align="center"><?php	echo $d['Langitude']; ?></td>
				<td height="25" align="center"><?php	echo $d['Latitude']; ?></td>

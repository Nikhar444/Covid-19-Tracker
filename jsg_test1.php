  ...
  ?>
    <form action="" method="post" name="track">
      ...
      <table width="70%" border="1" cellspacing="0" cellpadding="1" align="center">
       ...
       <table style="border:solid 5px black;" width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr><td align="center"> <b><font color="9E174F">Please Refresh Page After Each Report Generation</font></b> </td></tr>
        <tr>
          <td>&nbsp;</td>
        </tr>
        <tr>
          
          <td align="center" bgcolor="FFE4E1" colspan="4" style="color: #000;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Active Patient Name &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <?php 
        ...
        </SELECT><a href="jsg_test2.php">View All</a></td>
      </tr>
        <tr>
        <td align="center">OR</td>
      </tr>
      <tr>
        <td align="center" colspan="4" bgcolor="FFE4E1" style="color: #000;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Select Patient Phone No &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <?php 
        ...
        <tr class="a" id="a"></tr>
        <tr>
          <td align="center" colspan="4" bgcolor="FFE4E1" style="color: #000;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Buffer Area Around Home Address &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(In <b>KM</b>)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="distance" value="1" size="4"></td>
        </tr>
        <tr>
          <td>&nbsp;</td> 
        </tr>

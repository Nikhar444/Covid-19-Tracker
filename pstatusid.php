...
<style type="text/css">
  ...
  $pat_query="select * from pstatus  order by patient_id";
...
<?php
      $i=1;
      $sta=array("1"=>"Uploaded","2"=>"Not Available","3"=>"Lat-Long Not Available","4"=>"Pending","5"=>"Duplicate Phone No.","6"=>"Multiple Phone No in CDR");
      ...
      <!--  <td height="25" align="center"><?php  echo  $d['district'] ; ?></td>-->
        ...
        <td height="25" align="center"><?php  echo $d['p_name']; ?></td>
         ...
         <td height="25" align="center" bgcolor="#d2f779">
          <select name="status[]" onchange="setstatus()" id="statuspx<?php echo $d['patient_id'] ?>y">
             <option>Select Status</option>
           <?php foreach ($sta as $key => $value) {
             ?>
           
            <option value="<?php echo $key ?>" <?php echo ($key==$d['status'])?"selected":""?>><?php echo $value; ?>

              <?php  } ?>
         </select></td>
       <?php } else if($d['status']==0) { ?>

              <td height="25" align="center" bgcolor="pink">
          <select name="status[]" onchange="setstatus()" id="statuspx<?php echo $d['patient_id'] ?>y">
             <option>Select Status</option>
           <?php foreach ($sta as $key => $value) {
             ?>
       ...
       <?php } ?>        <td height="25" align="center"><?php  echo $d['p_addr']; ?></td>
